        ...
        <div id="about" className="about">
            <Container>
                <Container fluid className='align-items-center justify-content-center' style={{ paddingTop: '100px' }}>
                    ...
                    <Row>
                        <Col md={6} className="d-flex align-items-center justify-content-center custom-padding-left" style={{ paddingBottom: '50px', fontSize: '15px' }}>
                            <div>
                        ...
                        <Col md={6} className="d-flex align-items-center justify-content-center custom-padding-right" style={{ paddingBottom: '50px' }}>
                            <img
                                src={teamPhoto}
